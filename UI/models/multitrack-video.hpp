...
struct Preferences {
	...
	NLOHMANN_DEFINE_TYPE_INTRUSIVE(Preferences, maximum_aggregate_bitrate, maximum_video_tracks, extra_views,
				       vod_track_audio, width, height, framerate, canvas_width, canvas_height,
...
struct VideoEncoderConfiguration {
	...
	NLOHMANN_DEFINE_TYPE_INTRUSIVE_WITH_DEFAULT(VideoEncoderConfiguration, type, width, height, framerate,
						    gpu_scale_type, colorspace, range, format, view,
